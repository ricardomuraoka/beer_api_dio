...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Ricardo Muraoka";
    private static final String CONTACT_GITHUB = "https://gtihub.com/ricardomuraoka";
    private static final String CONTACT_EMAIL = "ricardomr8@hotmail.com";
